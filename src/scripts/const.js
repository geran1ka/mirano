...
export const typeChoices = document.querySelector(".filter__choices--type");
export const choicesBox = document.querySelector(".filter__choices-box--type");
export const filterTypeList = typeChoices.querySelector(".filter__type-list");

export const btns = document.querySelectorAll(".choices__btn");
